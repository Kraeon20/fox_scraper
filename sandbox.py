...
search = "lawyers in the bronx, ny"
total = 1000
@dataclass
class Business:
    """holds business data"""
...
def main():
    ...
    with sync_playwright() as p:
        ...
        for search_for_index, search_for in enumerate(search):
            ...
            for listing in listings:
                try:
                    ...
                    if page.locator(website_xpath).count() > 0:
                        website_link = page.locator(website_xpath).get_attribute('href')
                        page.goto(website_link)  # Clicks the website URL
